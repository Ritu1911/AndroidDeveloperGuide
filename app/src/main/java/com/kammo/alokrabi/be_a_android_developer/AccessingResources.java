...
public class AccessingResources extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accessing_resources);
        ...
        toolbar.setTitle("Accessing Resources");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(AccessingResources.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/topics/resources/accessing-resources.html";
        ...
        {
            Intent intent = new Intent(AccessingResources.this, NoInternet.class);
            startActivity(intent);
