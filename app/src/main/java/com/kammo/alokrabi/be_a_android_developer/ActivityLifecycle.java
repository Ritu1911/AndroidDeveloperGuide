...
public class ActivityLifecycle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("The Activity Lifecycle");
        ...
        String url = "https://developer.android.com/guide/components/activities/activity-lifecycle.html";
        ...
        {
            Intent intent = new Intent(ActivityLifecycle.this, NoInternet.class);
            startActivity(intent);
