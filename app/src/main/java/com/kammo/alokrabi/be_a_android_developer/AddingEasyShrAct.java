...
public class AddingEasyShrAct extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adding_easy_shr);
        ...
        toolbar.setTitle("Adding an Easy Share Action");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(AddingEasyShrAct.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/training/sharing/shareaction.html";
        ...
        {
            Intent intent = new Intent(AddingEasyShrAct.this, NoInternet.class);
            startActivity(intent);
