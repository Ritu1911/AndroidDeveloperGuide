...
public class AllowingOtherApps extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allowing_other_apps);
        ...
        toolbar.setTitle("Allowing Other Apps");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(AllowingOtherApps.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/training/basics/intents/filters.html";
        ...
        {
            Intent intent = new Intent(AllowingOtherApps.this, NoInternet.class);
            startActivity(intent);
