...
public class AppFundamentals extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_fundamentals);
        ...
        toolbar.setTitle("App Fundamentals");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(AppFundamentals.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/components/fundamentals.html";
        ...
        {
            Intent intent = new Intent(AppFundamentals.this, NoInternet.class);
            startActivity(intent);
