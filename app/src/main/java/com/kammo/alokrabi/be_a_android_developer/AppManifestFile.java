...
public class AppManifestFile extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_manifest_file);
        ...
        toolbar.setTitle("App Manifest File");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(AppManifestFile.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/topics/manifest/manifest-intro.html";
        ...
        {
            Intent intent = new Intent(AppManifestFile.this, NoInternet.class);
            startActivity(intent);
