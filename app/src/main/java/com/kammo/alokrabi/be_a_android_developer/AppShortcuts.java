...
public class AppShortcuts extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("App Shortcuts");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(AppShortcuts.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/topics/ui/shortcuts.html";
        ...
        {
            Intent intent = new Intent(AppShortcuts.this, NoInternet.class);
            startActivity(intent);
