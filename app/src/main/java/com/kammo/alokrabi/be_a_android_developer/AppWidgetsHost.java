...
public class AppWidgetsHost extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("App Widgets Host");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(AppWidgetsHost.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/topics/appwidgets/host.html";
        ...
        {
            Intent intent = new Intent(AppWidgetsHost.this, NoInternet.class);
            startActivity(intent);
