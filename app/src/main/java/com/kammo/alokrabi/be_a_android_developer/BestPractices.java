...
public class BestPractices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("App Permissions Best Practices");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(BestPractices.this, MainActivity.class);
        ...
        {
            Intent intent = new Intent(BestPractices.this, NoInternet.class);
            startActivity(intent);
