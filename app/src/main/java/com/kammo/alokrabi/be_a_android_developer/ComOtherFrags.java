...
public class ComOtherFrags extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_com_other_frags);
       ...
       // Runnable progressRunnable = new Runnable() {
        ...
        toolbar.setTitle("Communication Between Fragments");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(ComOtherFrags.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/training/basics/fragments/communicating.html";
        ...
        {
            Intent intent = new Intent(ComOtherFrags.this, NoInternet.class);
            startActivity(intent);
