...
public class CommonIntents extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Common Intents");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(CommonIntents.this, MainActivity.class);
        ...
        {
            Intent intent = new Intent(CommonIntents.this, NoInternet.class);
            startActivity(intent);
