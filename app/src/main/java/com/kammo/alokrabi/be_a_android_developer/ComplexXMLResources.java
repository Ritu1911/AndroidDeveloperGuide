...
public class ComplexXMLResources extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complex_xmlresources);
        ...
        toolbar.setTitle("Complex XML Resources");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(ComplexXMLResources.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/topics/resources/complex-xml-resources.html";
        ...
        {
            Intent intent = new Intent(ComplexXMLResources.this, NoInternet.class);
            startActivity(intent);
