...
public class CreateAppLinks extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_app_links);
        ...
        toolbar.setTitle("Create App Links for Instant Apps");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(CreateAppLinks.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/training/app-links/instant-app-links.html";
        ...
        {
            Intent intent = new Intent(CreateAppLinks.this, NoInternet.class);
            startActivity(intent);
