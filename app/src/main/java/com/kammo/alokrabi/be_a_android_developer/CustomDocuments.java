...
public class CustomDocuments extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Printing Custom Documents");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(CustomDocuments.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/training/printing/custom-docs.html";
        ...
        {
            Intent intent = new Intent(CustomDocuments.this, NoInternet.class);
            startActivity(intent);
