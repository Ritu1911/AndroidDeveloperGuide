...
public class HandlingRuntimeChanges extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_handling_runtime_changes);
        ...
        toolbar.setTitle("Handling Runtime Changes");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(HandlingRuntimeChanges.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/topics/resources/runtime-changes.html";
        ...
        {
            Intent intent = new Intent(HandlingRuntimeChanges.this, NoInternet.class);
            startActivity(intent);
