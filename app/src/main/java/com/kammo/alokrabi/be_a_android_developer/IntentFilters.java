...
public class IntentFilters extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Intents and Intent Filters");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(IntentFilters.this, MainActivity.class);
        ...
        {
            Intent intent = new Intent(IntentFilters.this, NoInternet.class);
            startActivity(intent);
