...
public class IntroductionActivities extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_introduction_activities);
        ...
        toolbar.setTitle("Introduction to Activities");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(IntroductionActivities.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/components/activities/intro-activities.html";
        ...
        {
            Intent intent = new Intent(IntroductionActivities.this, NoInternet.class);
            startActivity(intent);
