...
public class LanguageLocale extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_language_locale);
        ...
        toolbar.setTitle("Language and Locale");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(LanguageLocale.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/topics/resources/multilingual-support.html";
        ...
        {
            Intent intent = new Intent(LanguageLocale.this, NoInternet.class);
            startActivity(intent);
