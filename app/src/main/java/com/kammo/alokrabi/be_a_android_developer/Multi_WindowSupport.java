...
public class Multi_WindowSupport extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multi__window_support);
        ...
        toolbar.setTitle("Multi-Window Support");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(Multi_WindowSupport.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/topics/ui/multi-window.html";
        ...
        {
            Intent intent = new Intent(Multi_WindowSupport.this, NoInternet.class);
            startActivity(intent);
