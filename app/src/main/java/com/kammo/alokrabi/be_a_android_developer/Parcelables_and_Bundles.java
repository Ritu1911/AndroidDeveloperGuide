...
public class Parcelables_and_Bundles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parcelables_and__bundles);
        ...
        toolbar.setTitle("Parcelables and Bundles");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(Parcelables_and_Bundles.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/components/activities/parcelables-and-bundles.html";
        ...
        {
            Intent intent = new Intent(Parcelables_and_Bundles.this, NoInternet.class);
            startActivity(intent);
