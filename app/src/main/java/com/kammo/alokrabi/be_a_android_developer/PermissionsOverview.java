...
public class PermissionsOverview extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_permissions_overview);
        ...
        toolbar.setTitle("Permissions Overview");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(PermissionsOverview.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/topics/permissions/overview.html";
        ...
        {
            Intent intent = new Intent(PermissionsOverview.this, NoInternet.class);
            startActivity(intent);
