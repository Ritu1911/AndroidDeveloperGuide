...
public class Processes_and_AppLifecycle extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_processes_and__app_lifecycle);
        ...
        toolbar.setTitle("Processes and Application Lifecycle");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(Processes_and_AppLifecycle.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/components/activities/process-lifecycle.html";
        ...
        {
            Intent intent = new Intent(Processes_and_AppLifecycle.this, NoInternet.class);
            startActivity(intent);
