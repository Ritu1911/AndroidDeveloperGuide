...
public class ProvidingResources extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_providing_resources);
        ...
        toolbar.setTitle("Providing Resources");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(ProvidingResources.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/topics/resources/providing-resources.html";
        ...
        {
            Intent intent = new Intent(ProvidingResources.this, NoInternet.class);
            startActivity(intent);
