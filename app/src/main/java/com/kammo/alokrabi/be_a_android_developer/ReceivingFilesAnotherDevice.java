...
public class ReceivingFilesAnotherDevice extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receiving_files_another_device);
        ...
        toolbar.setTitle("Receiving Files from Another Device");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(ReceivingFilesAnotherDevice.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/training/beam-files/receive-files.html";
        ...
        {
            Intent intent = new Intent(ReceivingFilesAnotherDevice.this, NoInternet.class);
            startActivity(intent);
