...
public class RecentsScreen extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recents_screen);
        ...
        toolbar.setTitle("Recents Screen");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(RecentsScreen.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/components/activities/recents.html";
        ...
        {
            Intent intent = new Intent(RecentsScreen.this, NoInternet.class);
            startActivity(intent);
