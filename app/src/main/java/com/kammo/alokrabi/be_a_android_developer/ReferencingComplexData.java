...
public class ReferencingComplexData extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_referencing_complex_data);


        final ProgressDialog mDialog1 = new ProgressDialog(ReferencingComplexData.this);
        ...
        toolbar.setTitle("Referencing Complex Data");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(ReferencingComplexData.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/training/data-storage/room/referencing-data.html";
        ...
        {
            Intent intent = new Intent(ReferencingComplexData.this, NoInternet.class);
            startActivity(intent);
