...
public class ReportAPrb extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_aprb);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(ReportAPrb.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url ="https://usercomplaint.wordpress.com/";
        ...
        {
            Intent intent = new Intent(ReportAPrb.this, NoInternet.class);
            startActivity(intent);
