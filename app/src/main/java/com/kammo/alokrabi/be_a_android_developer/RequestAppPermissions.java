...
public class RequestAppPermissions extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_app_permissions);
        ...
        toolbar.setTitle("Request App Permissions");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(RequestAppPermissions.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/training/permissions/requesting.html";
        ...
        {
            Intent intent = new Intent(RequestAppPermissions.this, NoInternet.class);
            startActivity(intent);
