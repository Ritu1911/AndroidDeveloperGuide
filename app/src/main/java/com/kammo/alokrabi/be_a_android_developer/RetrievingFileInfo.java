...
public class RetrievingFileInfo extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrieving_file_info);
        ...
        toolbar.setTitle("Retrieving File Info.");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(RetrievingFileInfo.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/training/secure-file-sharing/retrieve-info.html";
        ...
        {
            Intent intent = new Intent(RetrievingFileInfo.this, NoInternet.class);
            startActivity(intent);
