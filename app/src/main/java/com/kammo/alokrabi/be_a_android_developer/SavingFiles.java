...
public class SavingFiles extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog mDialog1 = new ProgressDialog(SavingFiles.this);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(SavingFiles.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/training/data-storage/files.html";
        ...
        {
            Intent intent = new Intent(SavingFiles.this, NoInternet.class);
            startActivity(intent);
