...
public class SavingKeyValueSets extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog mDialog1 = new ProgressDialog(SavingKeyValueSets.this);
        ...
        toolbar.setTitle("Saving Key-Value Sets");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(SavingKeyValueSets.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/training/data-storage/shared-preferences.html";
        ...
        {
            Intent intent = new Intent(SavingKeyValueSets.this, NoInternet.class);
            startActivity(intent);
