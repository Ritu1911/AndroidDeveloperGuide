...
public class StartAnotherAct extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_another);
        final ProgressDialog mDialog1 = new ProgressDialog(StartAnotherAct.this);
        ...
        toolbar.setTitle("Start Another Activity");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(StartAnotherAct.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/training/basics/firstapp/starting-activity.html";
        ...
        {
            Intent intent = new Intent(StartAnotherAct.this, NoInternet.class);
            startActivity(intent);
