...
public class TasksBackStack extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tasks_back_stack);
        ...
        toolbar.setTitle("Tasks and Back Stack");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(TasksBackStack.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/guide/components/activities/tasks-and-back-stack.html";
        ...
        {
            Intent intent = new Intent(TasksBackStack.this, NoInternet.class);
            startActivity(intent);
