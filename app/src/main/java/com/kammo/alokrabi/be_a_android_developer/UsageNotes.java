...
public class UsageNotes extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usage_notes);


        final ProgressDialog mDialog1 = new ProgressDialog(UsageNotes.this);
        ...
        toolbar.setTitle("Permissions Usage Notes");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent = new Intent(UsageNotes.this, MainActivity.class);
                startActivity(intent);
            }
        });
        mProgress = (ProgressBar)findViewById(R.id.mProgress);
        String url = "https://developer.android.com/training/permissions/usage-notes.html";
        ...
        {
            Intent intent = new Intent(UsageNotes.this, NoInternet.class);
            startActivity(intent);
